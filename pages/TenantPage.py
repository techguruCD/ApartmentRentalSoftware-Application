...
class TenantPage(QFrame):
    ...
    def __init_UI(self):
        ...
        name_layout.addWidget(InputWrapper('First Name', self.name))
        name_layout.addWidget(InputWrapper('Last Name', self.last_name))
        ...
        contact_layout.addWidget(InputWrapper('Phone', self.phone))
        contact_layout.addWidget(InputWrapper('Mail', self.mail))
        ...
        parent_contact_layout.addWidget(InputWrapper("Parents' address", self.parent_address))
        parent_contact_layout.addWidget(InputWrapper("Parents' phone", self.parent_phone))
        ...
        layout.addWidget(InputWrapper('Note', self.note))
